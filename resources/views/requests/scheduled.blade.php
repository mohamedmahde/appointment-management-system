...
<div class="container mx-auto px-4 py-5">
    <h2 class="text-xl font-bold mb-4">الطلبات المؤجلة</h2>
    <table class="min-w-full bg-white">
        <thead>
            <tr>
                ...
                <th class="py-2 px-4 border-b">الوقت المحدد</th>
                <th class="py-2 px-4 border-b">تاريخ تحديد الموعد</th>
...
<td class="py-2 px-4 border-b">{{ $request->interviewee_name ?? '-' }}</td>
                ...
                <td class="py-2 px-4 border-b">{{ $request->scheduled_time ? $request->scheduled_time->format('Y-m-d H:i') : '-' }}</td>
                <td class="py-2 px-4 border-b">{{ $request->updated_at->format('Y-m-d H:i') }}</td>
            ...
            @empty
            <tr><td colspan="6" class="py-2 px-4 border-b text-center">لا توجد طلبات مؤجلة</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
